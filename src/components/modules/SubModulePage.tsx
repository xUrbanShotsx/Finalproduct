...
const CTA_LABELS: Record<string, string> = {
  ...
  "course-builder":       "Build Course",
  "training-register":    "Record Training",
  "competency-licences":  "Add Licence",
  "induction-builder":    "Build Induction",
  "training-matrix":      "View Matrix",
  "certificates-records": "Add Certificate",
