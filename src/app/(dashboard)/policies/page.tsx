...
export default async function PoliciesModulePage() {
  ...
  return (
    <div className="p-8 max-w-[1100px]">
      <div className="mb-8">
        <h1 className="text-[22px] font-semibold" style={{ color: "var(--b-text)" }}>Policies</h1>
        <p className="text-[13px] mt-0.5" style={{ color: "var(--b-text-muted)" }}>
          Agency policies, AML/CTF compliance program, licensing and professional development.
        </p>
      </div>
      {subModules.length > 0 ? (
