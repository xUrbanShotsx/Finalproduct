...
const AI_INSIGHTS: Record<Industry, InsightItem[]> = {
  construction: [
    ...
    {
      type: "ICAM FINDING",
      typeBg: "var(--b-accent-bg)",
      typeColor: "var(--b-accent-text)",
      confidence: "INC-044 investigation",
      title: "Systemic root cause: Procedure Difficulty",
      body: "TapRooT® analysis of INC-044 identified 'No procedure existed' as the root cause of the Level 3 near miss. 4 ICAM-linked corrective actions have been raised — 1 Immediate, 2 Systemic, 1 Preventive.",
  ...
  industrial: [
    ...
    },
    {
      ...
      typeBg: "var(--b-accent-bg)",
      typeColor: "var(--b-accent-text)",
      confidence: "3 investigations",
      title: "Org. factor in 3 of 3 ICAM investigations",
      body: "All three completed ICAM investigations this quarter identified an Organisational/Management Factor as the systemic cause. Most common TapRooT root cause: Management System — standards not established.",
  ...
  facilities: [
    ...
    },
    {
      ...
      typeBg: "var(--b-accent-bg)",
      typeColor: "var(--b-accent-text)",
      confidence: "2 investigations",
      title: "Common root cause: Work Direction",
      body: "TapRooT® analysis across 2 closed investigations found 'Work not correctly planned' as a shared root cause. Implementing pre-task planning requirements would address both systemic corrective actions.",
      action: "View actions",
      href: "/safety/actions",
    },
    {
...
const TASKS: Record<Industry, { id: string; label: string; sub: string }[]> = {
  construction: [
    ...
    { id: "INC-044",  label: "ICAM/TapRooT — complete INC-044 investigation",   sub: "Day 3 · TapRooT phase in progress · 4 actions open" },
