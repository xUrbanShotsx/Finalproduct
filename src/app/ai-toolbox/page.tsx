...
import {
  ...
  Building2, Cpu, Home, Settings, MapPin,
} from "lucide-react";
...
function DashboardPreview({ mockup }: { mockup: FeatureMockup }) {
  ...
  return (
    <div style={{ width: "100%", background: "#080808", border: "1px solid #1a1a1a", overflow: "hidden", filter: "drop-shadow(0 24px 64px rgba(0,0,0,0.7))" }}>
      {/* Browser chrome */}
      <div style={{ display: "flex", alignItems: "center", gap: "6px", padding: "9px 14px", borderBottom: "1px solid #1a1a1a", background: "#0d0d0d" }}>
        <div style={{ display: "flex", gap: "5px" }}>
          <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#ff6058" }} />
          <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#ffbd2e" }} />
          <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#28c840" }} />
        </div>
        <div style={{ flex: 1, margin: "0 10px", padding: "3px 10px", fontSize: "10px", textAlign: "center", border: "1px solid #1e1e1e", background: "#111", color: "#444", letterSpacing: "0.01em" }}>
          {mockup.url}
        </div>
      ...
      <div style={{ display: "flex", height: "440px" }}>
        ...
        {/* Sidebar */}
        <div style={{ width: "148px", flexShrink: 0, borderRight: "1px solid #1a1a1a", background: "#0d0d0d", display: "flex", flexDirection: "column" }}>
          {/* Logo */}
          <div style={{ display: "flex", alignItems: "center", gap: "7px", padding: "10px 10px 10px", borderBottom: "1px solid #1a1a1a", flexShrink: 0 }}>
            ...
            {SIDEBAR_MODULES.map(m => (
              <div key={m.name}>
                <div style={{
                  ...
                  background: m.name === mockup.module ? "#1a1a1a" : "transparent",
                  borderLeft: m.name === mockup.module ? `2px solid ${m.color}` : "2px solid transparent",
                }}>
                  <div style={{ width: "8px", height: "8px", background: m.color, opacity: m.name === mockup.module ? 1 : 0.2, flexShrink: 0 }} />
                ...
                {m.name === mockup.module && (
                  <div style={{ marginLeft: "18px", paddingLeft: "8px", borderLeft: "1px solid #1e1e1e" }}>
                    {subItems.map(s => (
                      <div key={s} style={{
                        padding: "3.5px 6px", fontSize: "9.5px",
                        color: s === mockup.submodule ? "#e0e0e0" : "#333",
                        background: s === mockup.submodule ? "#1e1e1e" : "transparent",
                        fontWeight: s === mockup.submodule ? 600 : 400,
                      }}>{s}</div>
                    ))}
                  </div>
                )}
          ...
          <div style={{ padding: "8px 10px", borderTop: "1px solid #1a1a1a", display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: "9px", fontWeight: 600, color: "#555", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>J. Smith</div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          {/* Topbar */}
          <div style={{ display: "flex", alignItems: "center", gap: "6px", padding: "0 14px", height: "36px", borderBottom: "1px solid #1a1a1a", background: "#0d0d0d", flexShrink: 0 }}>
            ...
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "8px" }}>
              {/* AI badge */}
              <div style={{ display: "flex", alignItems: "center", gap: "4px", padding: "2px 6px", background: `${YELLOW}12`, border: `1px solid ${YELLOW}20` }}>
                <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: YELLOW }} />
                <span style={{ fontSize: "8px", fontWeight: 700, color: YELLOW, fontFamily: "monospace" }}>AI ACTIVE</span>
              </div>
              <div style={{ fontSize: "8.5px", fontWeight: 700, padding: "2px 6px", background: "rgba(26,138,74,0.12)", color: GREEN }}>OWNER</div>
            </div>
          </div>

          {/* Page header */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", borderBottom: "1px solid #1a1a1a", background: "#0d0d0d", flexShrink: 0 }}>
            <div>
      ...
      <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px", height: "100%" }}>
        ...
        <div style={{ padding: "10px 12px", border: `1px solid ${YELLOW}25`, background: `${YELLOW}06` }}>
          ...
          <div style={{ display: "flex", gap: "8px", fontSize: "8.5px", color: "#444", marginBottom: "8px" }}>
            <span>Site 01 · Level 3</span><span style={{ color: "#222" }}>·</span>
            <span>Presenter: J. Smith</span><span style={{ color: "#222" }}>·</span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
            {[
              ...
              "Exclusion zones — establish a 2m perimeter around EWP base. Spotter required at all times.",
              "Weather limits — cease operations if wind exceeds 45 km/h or lightning within 10 km.",
              "Emergency descent — demonstrate manual lowering procedure before elevated work begins.",
              "Rescue plan — confirm procedures are briefed and equipment is on standby.",
            ].map((pt, i) => (
        ...
        {/* Existing talks list */}
        <div style={{ fontSize: "8px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#2a2a2a", paddingTop: "2px" }}>Recent talks</div>
        {[
          { topic: "Electrical Safety — LOTO", date: "12 Jun", att: 8 },
          { topic: "Manual Handling — Lower Back Risk", date: "9 Jun", att: 12 },
          { topic: "Heat Stress Management", date: "5 Jun", att: 7 },
        ].map((t, i) => (
  ...
  /* 02 — SWMS Drafter */
  {
    ...
    content: (
      <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px", height: "100%" }}>
        ...
        <div style={{ border: `1px solid ${YELLOW}22`, background: `${YELLOW}05` }}>
          ...
          <div style={{ padding: "8px 10px" }}>
            <div style={{ display: "flex", gap: "16px", marginBottom: "8px" }}>
              <div>
                <div style={{ fontSize: "7.5px", color: "#2a2a2a", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em" }}>HRCW</div>
                <div style={{ fontSize: "8.5px", color: "#666", marginTop: "2px" }}>Work at heights (&gt; 2m fall)</div>
              </div>
              <div>
                <div style={{ fontSize: "7.5px", color: "#2a2a2a", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em" }}>Location</div>
                <div style={{ fontSize: "8.5px", color: "#666", marginTop: "2px" }}>Level 3 Façade, Site 01</div>
              </div>
            </div>
            {/* Hazard table */}
            <div style={{ border: "1px solid #1e1e1e", overflow: "hidden" }}>
              ...
              {[
                ["Fall from height", "Full body harness + anchor"],
                ["Struck by objects", "Exclusion zone + spotter"],
                ["Electrocution (OHL)", "3m clearance enforced"],
              ].map(([h, c], i) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderTop: i > 0 ? "1px solid #1a1a1a" : undefined }}>
                  <div style={{ padding: "5px 8px", fontSize: "8.5px", color: "#555", borderRight: "1px solid #1a1a1a", display: "flex", alignItems: "center", gap: "4px" }}>
                    <AlertTriangle style={{ width: "7px", height: "7px", color: "#f06060", flexShrink: 0 }} />{h}
                  </div>
                  <div style={{ padding: "5px 8px", fontSize: "8.5px", color: "#555", display: "flex", alignItems: "center", gap: "4px" }}>
                    <CheckCircle2 style={{ width: "7px", height: "7px", color: GREEN, flexShrink: 0 }} />{c}
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Other SWMS */}
        {[
          { ref: "SWMS-046", task: "Concrete pour — Level 2 slab", status: "Active", workers: 6 },
          { ref: "SWMS-045", task: "Scaffold erect — North elevation", status: "Active", workers: 4 },
          { ref: "SWMS-044", task: "Electrical rough-in — B-Block", status: "Closed", workers: 2 },
        ].map((s, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 8px", border: "1px solid #1a1a1a", background: "#0d0d0d" }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                <span style={{ fontSize: "8px", fontFamily: "monospace", color: "#333" }}>{s.ref}</span>
                <span style={{ fontSize: "9px", fontWeight: 600, color: "#777" }}>{s.task}</span>
              </div>
      ...
      <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px", height: "100%" }}>
        ...
        <div style={{ border: `1px solid ${YELLOW}22`, background: `${YELLOW}05` }}>
          ...
          <div style={{ padding: "8px 10px", display: "flex", flexDirection: "column", gap: "5px" }}>
            {[
              { label: "IMMEDIATE", color: "#f06060", items: ["Isolate EWP — do not operate until inspection complete", "Notify SafeWork NSW under WHS Act s.35", "Preserve scene — no clean-up until authorised"] },
              { label: "72 HRS", color: "#b58a1b", items: ["Root cause: ground conditions, training, pre-op records", "Engage third-party structural inspector"] },
            ].map(group => (
              <div key={group.label}>
                ...
                {group.items.map((item, j) => (
                  <div key={j} style={{ display: "flex", alignItems: "start", gap: "5px", marginBottom: "3px" }}>
                    <div style={{ width: "12px", height: "12px", border: `1px solid ${group.color}40`, background: `${group.color}10`, flexShrink: 0, marginTop: "0px" }} />
  ...
  /* 04 — Permit Controls */
  {
    ...
    content: (
      <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px", height: "100%" }}>
        ...
        <div style={{ border: `1px solid ${YELLOW}22`, background: `${YELLOW}05` }}>
          ...
          <div style={{ padding: "8px 10px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              {[
                { done: true,  text: "Fire warden assigned, briefed and positioned" },
                { done: true,  text: "Fire extinguisher within 10m of work area" },
                { done: true,  text: "Combustibles cleared within 3m radius" },
                { done: false, text: "30-minute fire watch after work completion" },
                { done: false, text: "Notify building manager — suppression bypass" },
                { done: false, text: "Isolate smoke detectors in affected zone" },
              ].map((c, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  ...
                  <span style={{ fontSize: "8.5px", color: c.done ? "#555" : "#444", textDecoration: c.done ? "none" : "none", lineHeight: 1.4 }}>{c.text}</span>
                </div>
              ))}
            </div>
        ...
        {/* Other permits */}
        {[
          { ref: "PTW-030", type: "Confined Space", loc: "Basement B2", status: "Active" },
          { ref: "PTW-029", type: "Electrical Isolation", loc: "DB-3, Level 2", status: "Closed" },
        ].map((p, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 8px", border: "1px solid #1a1a1a", background: "#0d0d0d" }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                <span style={{ fontSize: "8px", fontFamily: "monospace", color: "#333" }}>{p.ref}</span>
                <span style={{ fontSize: "9px", fontWeight: 600, color: "#666" }}>{p.type}</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "3px", marginTop: "1px" }}>
                <MapPin style={{ width: "7px", height: "7px", color: "#2a2a2a" }} />
                <span style={{ fontSize: "8px", color: "#2e2e2e" }}>{p.loc}</span>
              </div>
            </div>
    ...
    content: (
      <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: "8px", height: "100%" }}>
        ...
        <div style={{ border: `1px solid ${YELLOW}22`, background: `${YELLOW}05` }}>
          ...
          <div style={{ padding: "8px 10px" }}>
            <div style={{ fontSize: "7.5px", fontWeight: 700, color: "#2e2e2e", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "5px" }}>Mandatory (no work without)</div>
            <div style={{ display: "flex", flexDirection: "column", gap: "3px", marginBottom: "8px" }}>
              {[
                "Rigging Licence — Basic or Intermediate (HRCW)",
                "Construction Induction — White Card CPCCWHS1001",
                "Working at Heights — site-specific training",
              ].map((lic, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <CheckCircle2 style={{ width: "10px", height: "10px", color: GREEN, flexShrink: 0 }} />
                  <span style={{ fontSize: "8.5px", color: "#555" }}>{lic}</span>
                </div>
              ))}
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
              {["EWP Licence — 11m boom or scissors", "Dogging Licence — crane lift directing"].map((lic, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                  <div style={{ width: "10px", height: "10px", border: "1px solid #2a2a2a", flexShrink: 0 }} />
                  <span style={{ fontSize: "8.5px", color: "#3a3a3a" }}>{lic}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {[
          { name: "T. Morrison", role: "Rigger", alert: "First Aid expires 2 Jul", level: "warn" },
          { name: "K. Barnes", role: "Rigger", alert: "All licences current", level: "ok" },
          { name: "D. Walsh", role: "Dogman", alert: "EWP ticket expired", level: "err" },
        ].map((w, i) => (
...
const HOW_STEPS = [
  ...
  { n: "02", title: "Provide the job context",    body: "Answer a few simple fields: task name, site, industry, personnel. Briesa's AI uses this to generate content specific to your work — not generic templates." },
      ...
      <section style={{ borderBottom: "1px solid #1a1a1a", padding: "96px 0" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: "16px", alignItems: "start" }}>
              ...
              {AI_FEATURES.map((f, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderLeft: activeFeature === i ? `2px solid ${YELLOW}` : "2px solid transparent",
            ...
            {/* Dashboard preview */}
            <DashboardPreview mockup={FEATURE_MOCKUPS[activeFeature]} />
          </div>
        </div>
      </section>
            ...
            {CAPABILITY_CARDS.map((c, i) => {
              ...
              return (
                <Reveal key={i} delay={i * 0.04}>
                  <div style={{ background: "#0a0a0a", padding: "28px 24px", transition: "background 150ms" }}
